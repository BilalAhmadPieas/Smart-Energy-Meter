...
void loop() {
  ...
  if (elapsedTime >= 10 || previouspower != totalpowerconsumption) {
    ...
    if (EVConnected && availabletime <= timerequired) {
      ...
      String feedback1 = "SOC Possible: " + String(SocPossible) + ".";
      publishData(Feedback1, feedback1);
      String feedback2 = "Turn OFF NC load or Use Emergency Mode for Fast Charge.";
    ...
    else
    {
      ...
      {
        String feedback1 = "Load is more than allowed limit";
        publishData(Feedback1, feedback1);
        String feedback2 = "Please turn off NC Load";
        publishData(Feedback2, feedback2);
      }
    }
